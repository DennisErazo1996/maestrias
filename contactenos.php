            ...
            <div class="uk-width-1-1 uk-width-2-5@s">
                <div class="fondo-verde texto-blanco uk-padding">
                    <div class="uk-margin-medium-bottom">
                        ...
                        <p class="uk-margin-remove-top uk-text-left">Barrio El Espino, municipio de Catacamas, departamento de Olancho</p>
                    ...
                    <div>
                        ...
                        <a class="uk-link-reset" href="mailto:fct@unag.edu.hn"><span class="uk-margin-small-right uk-icon" data-uk-icon="mail"></span> Facultad de Ciencias Tecnológicas</a><br>
                        <a class="uk-link-reset" href="mailto:fct@unag.edu.hn"><span class="uk-margin-small-right uk-icon" data-uk-icon="mail"></span> Facultad de Medicina Veterinaria y Zootecnia</a><br>
                        <a class="uk-link-reset" href="mailto:fct@unag.edu.hn"><span class="uk-margin-small-right uk-icon" data-uk-icon="mail"></span> Facultad de Ciencias de la Tierra y la Conservación</a>
                    </div>
                </div>
            </div>
