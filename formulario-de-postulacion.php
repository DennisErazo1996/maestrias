...
<title>Formulario de postulación | UNAG</title>
<?php include_once('templates/header.php'); ?>

<?php
    $maestria = $_GET['maestria'];
    $nombre_maestria = null;

    if($maestria === 'mca'){
        $nombre_maestria = 'Maestría en Ciencias Agroalimentarias';
    };
?>
<main>
    ...
    <div class="uk-container uk-container-small">
        ...
        <h3 class="uk-heading-bullet uk-margin-remove-bottom uk-margin-small-top">
            <span><?php echo $nombre_maestria; ?></span>
        </h3>
        <p class="uk-margin-remove-top">Para postularse, por favor complete el siguiente formulario. Campos con * son
            requeridos.</p>

        <input style="display:none" type="text" id="maestria" value="<?php echo $nombre_maestria; ?>">
        <div class="uk-margin-large-bottom">
            <ul data-uk-accordion>
                <li class="uk-open">
                    <a class="uk-accordion-title uk-padding-small fondo-verde-claro texto-verde" href="#">DATOS
                        PERSONALES</a>
                    <div class="uk-accordion-content uk-padding fondo-verde-claro">
                        <div class="uk-grid-small" data-uk-grid>
                            ...
                            <div class="uk-width-1-1 uk-width-1-2@s">
                                <label class="uk-form-label" for="salario">Salario *</label>
                                <div class="uk-form-controls">
                                    <input id="salario" class="uk-input" type="text">
                                </div>
                            </div>
                            <div class="uk-width-1-1 uk-width-1-2@s">
                                <label class="uk-form-label" for="dedicacion">Tiempo de dedicación al programa
                                    *</label><br>
                                <label><input class="uk-radio" type="radio" name="dedicacion" value="50%"> 50%</label>
                                <label><input class="uk-radio" type="radio" name="dedicacion" value="75%"> 75%</label>
                                <label><input class="uk-radio" type="radio" name="dedicacion" value="100%"> 100%</label>
                            </div>
                        </div>
                    </div>
                </li>
                <li>
                    ...
                    <div class="uk-accordion-content uk-padding fondo-verde-claro">
                        <div class="uk-grid-small" data-uk-grid>
                            ...
                            <div class="uk-width-1-1">
                                <label class="uk-form-label" for="tesis1">Título de la Tesis o Trabajo de graduación
                                    *</label>
                                <div class="uk-form-controls">
                            ...
                            <div class="uk-width-1-1">
                                <h5 class="uk-heading-bullet uk-margin-large-top"><span>Si tiene otro título, indíquelo
                                        aquí</span></h5>
                            </div>
                            <div class="uk-width-1-1 uk-width-1-2@s">
                ...
                <li>
                    <a class="uk-accordion-title uk-padding-small fondo-verde-claro texto-verde" href="#">ANTECEDENTES
                        PROFESIONALES</a>
                    <div class="uk-accordion-content uk-padding fondo-verde-claro">
                        <h5 class="uk-heading-bullet"><span>Instituciones en las que ha trabajado recientemente</span>
                        </h5>
                        ...
                        <h5 class="uk-heading-bullet"><span>Institución o empresa en la que trabaja actualmente</span>
                        </h5>
                        <div class="uk-grid-small" data-uk-grid>
                ...
                <li>
                    <a class="uk-accordion-title uk-padding-small fondo-verde-claro texto-verde" href="#">OTROS
                        DATOS</a>
                    <div class="uk-accordion-content uk-padding fondo-verde-claro">
                        <h5 class="uk-heading-bullet"><span>Idiomas *</span></h5>
                        <div class="uk-grid-small uk-child-width-1-1 uk-child-width-1-1@s" data-uk-grid>
                            <div class="uk-overflow-auto">
                                <table class="uk-table uk-table-small uk-table-divider">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Lectura</td>
                                            <td><input id="lecturaEspaniol" class="uk-input" type="text" onkeydown="upperCaseF(this)"></td>
                                            <td><input id="lecturaIngles" class="uk-input" type="text" onkeydown="upperCaseF(this)"></td>
                                            <td><input id="lecturaOtros" class="uk-input" type="text" onkeydown="upperCaseF(this)"></td>
                                            <td><strong>B:</strong> Bien</td>
                                            
                                        </tr>
                                        <tr>
                                            <td>Escritura</td>
                                            <td><input id="escrituraEspaniol" class="uk-input" type="text" onkeydown="upperCaseF(this)"></td>
                                            <td><input id="escrituraIngles" class="uk-input" type="text" onkeydown="upperCaseF(this)"></td>
                                            <td><input id="escrituraOtros" class="uk-input" type="text" onkeydown="upperCaseF(this)"></td>
                                            <td><strong>S:</strong> Suficiente</td>
                                            
                                        </tr>
                                        <tr>
                                            <td>Conversación</td>
                                            <td><input id="conversacionEspaniol" class="uk-input" type="text" onkeydown="upperCaseF(this)"></td>
                                            <td><input id="conversacionIngles" class="uk-input" type="text" onkeydown="upperCaseF(this)"></td>
                                            <td><input id="conversacionOtros" class="uk-input" type="text" onkeydown="upperCaseF(this)"></td>
                                            <td><strong>M:</strong> Mínimo</td>
                        ...
                        <h5 class="uk-heading-bullet"><span>Fuente de financiamiento para cursar la Maestría *</span>
                        </h5>
                        <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                            <label><input class="uk-radio" type="radio" name="fuente" value="Propio"> Propio</label>
                            <label><input class="uk-radio" type="radio" name="fuente" value="Institución o Empresa">
                                Institución o Empresa</label>
                        ...
                        <div class="uk-child-width-1-1" data-uk-grid>
                            <div>
                                <label class="uk-form-label" for="p1">¿Por qué ha decidido estudiar la
                                    <?php echo $nombre_maestria; ?>?</label>
                                <div class="uk-form-controls">
                                    <textarea id="p1" class="uk-textarea" rows="5"></textarea>
                                </div>
                            </div>
                            <div <?php if($maestria !== 'mca'){ echo 'style="display:none"'; };  ?>>
                                <div class="uk-grid-small uk-child-width-1-1 uk-child-width-1-2@s" data-uk-grid>
                                    <div>
                                        <label class="uk-form-label" for="p2">¿Qué orientación de la Maestría le
                                            interesa cursar?</label>
                                        <div class="uk-form-controls">
                                    ...
                                    <div>
                                        <label class="uk-form-label" for="p3">¿Qué tipo de Maestría le interesa
                                            cursar?</label>
                                        <div class="uk-form-controls">
                            ...
                            <div>
                                <label class="uk-form-label" for="p4">Resuma brevemente lo que usted espera del programa
                                    de <?php echo $nombre_maestria; ?>.</label>
                                <div class="uk-form-controls">
                                    <textarea id="p4" class="uk-textarea" rows="5"></textarea>
                                </div>
                            </div>
                            <div>
                                <label class="uk-form-label" for="p5">Otros datos que puedan ser relevantes para su
                                    postulación.</label>
                                <div class="uk-form-controls">
                                    <textarea id="p5" class="uk-textarea" rows="5"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li>
                    <a class="uk-accordion-title uk-padding-small fondo-verde-claro texto-verde" href="#">SUBIR
                        DOCUMENTO PDF</a>
                    <div class="uk-accordion-content uk-padding fondo-verde-claro">
...
<script src="scripts/postulacion-v1.js"></script>
<script>
