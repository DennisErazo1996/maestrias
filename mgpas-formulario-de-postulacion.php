...
<main>
    ...
    <div class="uk-container uk-container-small">
        ...
        <h3 class="uk-heading-bullet uk-margin-remove-bottom uk-margin-small-top"><span>Maestría en Gestión de la Producción Animal Sostenible</span></h3>
                ...
                <li>
                    ...
                    <div class="uk-accordion-content uk-padding fondo-verde-claro">
                        ...
                        <div class="uk-margin uk-grid-small uk-child-width-auto uk-grid">
                            ...
                            <label><input class="uk-radio" type="radio" name="fuente" value="Otros"> Otros</label>
                        </div>
                        <h5 class="uk-heading-bullet"><span>Datos Complementarios *</span></h5>
                        <div class="uk-child-width-1-1" data-uk-grid>
                            <div>
                                <label class="uk-form-label" for="p1">¿Por qué ha decidido estudiar la Maestría en Gestión de la Producción Animal Sostenible?</label>
                                <div class="uk-form-controls">
...
<script src="scripts/mgpas-postulacion-v1.js"></script>
